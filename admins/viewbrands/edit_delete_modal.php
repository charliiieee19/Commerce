        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit.php">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">Brand Title:</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="brand_title" value="<?php echo $row['brand_title']; ?>">
					</div>
				</div>
            </div> 
			</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">	
				...
				<h2 class="text-center"><?php echo $row['brand_id'].', '.$row['brand_title']; ?></h2>
			</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                <a href="delete.php?brand_id=<?php echo $row['brand_id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
            </div>
