...
<div class="modal fade" id="view_pass_<?php echo $row['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="editpass.php">
                ...
                <input type="hidden" class="form-control" name="hashold" value="<?php echo $row['user_pass'];  ?>">
